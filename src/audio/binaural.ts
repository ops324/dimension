 ...
 *
 * ・搬送波 fc = 198Hz。これは 99×2、すなわち **1D の鐘そのもの**であり、
 *   同時に **396Hz(ソルフェジオ「解放」= 3D の鐘)の半分**でもある。
 *   六つの鐘(198 / 297 / 396 / 495 / 594 / 693Hz)はすべて 99Hz の倍音列に
 ...
 * ・片側 0.05。チェーンを通ると -48dBFS で、198Hz の等ラウドネス(ISO 226)で
...
/** 搬送波。99Hz(鐘の基音)の 2 倍音 = 1D の鐘 = 396Hz(解放)の半分 */
const CARRIER_HZ = 198;
